...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="py-32 bg-gradient-to-b from-background to-purple-50 dark:to-purple-950/20 relative overflow-hidden">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@c-technology-inc.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1">WhatsApp Community</h4>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-lg bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors"
                >
                ...
                <a
                  href="https://www.instagram.com/c__technology/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 rounded-lg bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors"
                >
