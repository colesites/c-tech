      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-4xl mx-auto mb-12">
            Connect with like-minded individuals in our vibrant WhatsApp
            community. Share insights, ask questions, and learn from one another
            as you navigate your tech journey.
          </p>
          <Link
        ...
        >
          ...
          <p className="text-lg text-left md:text-center text-white/70 max-w-4xl mx-auto">
            We&apos;re not just building a company, We&apos;re more than a tech
            company. We&apos;re a catalyst for change, a pioneer of innovation,
            and a builder of dreams.
          </p>
        </motion.div>
        ...
        >
          <p className="text-lg text-left md:text-center text-white/70 max-w-3xl mx-auto mb-8">
            We&apos;re inviting visionary investors, talented creators, and
            passionate users to join us on this journey.
          </p>
          ...
          <div className="space-y-4 text-left md:text-center">
            <p className="text-2xl md:text-4xl font-bold tracking-wider">
              that&apos;s <span className="text-blue-400">smarter</span>
            </p>
            <p className="text-2xl md:text-4xl font-bold tracking-wider">
              that&apos;s <span className="text-purple-400">safer</span>
            </p>
          </div>
        </motion.div>
